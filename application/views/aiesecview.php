...
<html lang="en">
    <head>
        ...
        <link href="<?php echo base_url('asets/grocery_crud/css/chosen/chosen.min.css'); ?>" rel="stylesheet"/>
        <link href="<?php echo base_url('asets/grocery_crud/css/chosen/chosen.css'); ?>" rel="stylesheet"/>
        <link href="<?php echo base_url('asets/grocery_crud/themes/flexigrid/css/flexigrid.css'); ?>" rel="stylesheet"/>

        <!--  CSS for Demo Purpose, don't include it in your project     -->
        <link href="<?php echo base_url('/plantilla/assets/css/demo.css'); ?>" rel="stylesheet" />
        <!--  Light Bootstrap Table core CSS    -->
        <link href="<?php echo base_url('/plantilla/assets/css/perro.css');?>" rel="stylesheet"/>
